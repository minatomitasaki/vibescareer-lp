...
export const SUCCESS_CASES: SuccessCase[] = [
  ...
  },
  {
    ...
    offers: "3 社",
    body:
      "新聞記者として現場を駆け回る毎日にやりがいはあったのですが、「自分の書く力を、もっと違う形で活かしたい」という思いが強くなり、転職を考え始めました。他社サービスでは「記者経験が活きる」と同業界の求人ばかりを紹介され、自分の可能性を狭められている気がしていました。VibesCareer では VibesRadar の診断で「言語化力 × 論理構成力」という強みを可視化していただき、未経験のセールスライティング業界への挑戦を後押ししてくれました。応募書類から面接対策まで丁寧に伴走いただき、第一志望から内定獲得。文章で「人を動かす」面白さを、毎日感じています。",
  },
  {
    id: "case4",
    name: "Eさん",
    ...
    offers: "3 社",
    body:
      "空港免税店のスタッフとして接客と販売の最前線で経験を積んできましたが、「自分でゼロから事業を作る側に回りたい」という気持ちが日に日に強くなっていきました。とはいえ未経験で新規事業開発に挑戦するなんて無謀だろうと、諦めかけていたところに、VibesCareer のアドバイザーさんが私の経験を「現場感覚 × 顧客理解」という独自の強みに翻訳してくれました。VibesRadar での自己分析を踏まえた具体的なキャリア設計のおかげで、自信を持って選考に臨むことができ、第一志望から内定をいただけました。今は事業をゼロから創る面白さに、毎日刺激を受けています。",
  },
];
