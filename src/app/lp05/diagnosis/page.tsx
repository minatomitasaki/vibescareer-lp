...
// =====================================================
// LP05 診断ページ (/lp05/diagnosis)
// LP04 と同一の 8 問診断。ただし LP05 は LINE URL が 1 本のため、
// 結果は 12 パターン (職種6 × 職場2) をそのまま使う (LP04 のような 3 集約はしない)。
// 回答後は /lp05/analyzing へ遷移する。
// =====================================================
...
export default function DiagnosisPage() {
  ...
  const handleSubmit = () => {
    ...
    // 診断ロジックで 12 パターンの resultId をそのまま使う。
