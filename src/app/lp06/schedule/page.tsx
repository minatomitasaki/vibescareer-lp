// LP06 日程調整ページ (/lp06/schedule) — 白ベース(標準テーマ)
// /lp06/entry のフォーム送信後にここへ遷移。Lp02SchedulePicker (Google Calendar 連携) を再利用。
...
export default function Lp06SchedulePage() {
  return (
    <main className="min-h-screen bg-white">
      <div className="lp-container">
        <header className="relative flex items-center justify-start bg-white px-4 py-3">
        ...
        <section className="px-4 pt-8 pb-4">
          ...
          <p className="mt-4 text-center text-[13.5px] leading-[1.95] text-text-secondary">
            ...
            <br />
            <strong className="text-brand-primary">確実に参加できる日程</strong>
            を選択ください。
          </p>
        </section>
      </div>
