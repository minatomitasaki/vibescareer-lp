// LP06 サンクスページ (/lp06/thanks)
//
// /lp06/schedule の予約完了時に Lp02SchedulePicker から遷移してくる。
// 中身は lp04/thanks と同一 (ルート URL だけ LP06 専用に分けたもの)。
...
export default function Lp06ThanksPage() {
  return (
