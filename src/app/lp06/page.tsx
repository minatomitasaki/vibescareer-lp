...
import { Lp06CtaButton } from "@/components/lp06/Lp06LineCta";
import {
  SUCCESS_CASES,
  type SuccessCase,
  ADVISORS,
...
// CTA ボタン (Lp06CtaButton) と LINE アイコンは
// src/components/lp06/Lp06LineCta.tsx (クライアントコンポーネント) に分離。
// クリック時に dataLayer へ `lp06_line_cta_click` を push して GTM 計測に乗せる。
