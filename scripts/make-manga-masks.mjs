...
const MASKS = {
  // LP06 セクション2: 上段(オフィス3声)だけを再描画。下段(見上げる主人公+リード)は保持。
  "lp06-section2-mask-top.png": [
    [0, 0, 1024, 650], // 上段 0〜650px を透明=再描画 / 650px以下は不透明=元画像保持
  ],
  // LP06 セクション4: 最下部(封蝋スタンプ+※注釈)だけを再描画。上(WEAPON01/02)は保持。
  "lp06-section4-mask-bottom.png": [
    [0, 1290, 1024, 246], // 最下部 1290〜1536px を透明=再描画
  ],
